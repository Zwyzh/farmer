package com.farmer.core.bean;

import com.farmer.core.bean.BeanDesc.PropDesc;
import com.farmer.core.bean.copier.BeanCopier;
import com.farmer.core.bean.copier.CopyOptions;
import com.farmer.core.bean.copier.ValueProvider;
import com.farmer.core.collection.CollUtil;
import com.farmer.core.convert.Convert;
import com.farmer.core.lang.Editor;
import com.farmer.core.lang.Filter;
import com.farmer.core.map.CaseInsensitiveMap;
import com.farmer.core.map.MapUtil;
import com.farmer.core.util.ArrayUtil;
import com.farmer.core.util.ClassUtil;
import com.farmer.core.util.ReflectUtil;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.farmer.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：com.farmer.TestEntity匹配com.farmer.TestEntity
	 *
	 * @param bean Bean
